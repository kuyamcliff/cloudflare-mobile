...
object Routes {
    ...
    const val ACCESS_DIRECTORY = "account/{accountId}/accessdirectory"
    const val PLATFORM = "account/{accountId}/platform"
    ...
    const val CONFIG_RULES = "zone/{zoneId}/{zoneName}/configrules"
    const val PERFORMANCE = "zone/{zoneId}/{zoneName}/performance"
    const val LEGACY_FIREWALL = "zone/{zoneId}/{zoneName}/legacyfirewall"
    const val CLIENT_CERTIFICATES = "zone/{zoneId}/{zoneName}/clientcertificates"
    const val ZONE_OWNERSHIP = "zone/{zoneId}/{zoneName}/zoneownership"
    ...
    fun accessDirectory(accountId: String) = "account/$accountId/accessdirectory"
    fun platform(accountId: String) = "account/$accountId/platform"
    ...
    fun configRules(zoneId: String, zoneName: String) = "zone/$zoneId/${encode(zoneName)}/configrules"
    fun performance(zoneId: String, zoneName: String) = "zone/$zoneId/${encode(zoneName)}/performance"
    fun legacyFirewall(zoneId: String, zoneName: String) = "zone/$zoneId/${encode(zoneName)}/legacyfirewall"
    fun clientCertificates(zoneId: String, zoneName: String) = "zone/$zoneId/${encode(zoneName)}/clientcertificates"
    fun zoneOwnership(zoneId: String, zoneName: String) = "zone/$zoneId/${encode(zoneName)}/zoneownership"
